...
function ProductCard({ id, statements }) {
    const mfr = (statements?.manufacturer || [])[0]?.mainsnak?.datavalue?.value?.text
    const mpn = (statements?.manufacturer_part_num || [])[0]?.mainsnak?.datavalue?.value
    const img = (statements?.image || [])[0]?.mainsnak?.datavalue?.value
    const desc = (statements?.description || [])[0]?.mainsnak?.datavalue?.value?.text
